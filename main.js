...
let cardSlide = document.querySelectorAll(".card-slide");

for (i = 0; i < cardSlide.length; i++) {
  console.log(cardSlide[i]);
  cardSlide[i].addEventListener("click", () => {
    cardSlide.style.left = "-100%";
  });
}

// scroll slide

let imageSlide = document.querySelectorAll("image-slide");

for (i = 0; i < imageSlide.length; i++) {
  console.log(imageSlide[i]);
  imageSlide[i].addEventListener("click", () => {
